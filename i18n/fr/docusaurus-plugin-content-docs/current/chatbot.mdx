---
lastmod: '2026-08-19T14:50:03.198Z'
...
<Admonition type="note" title="Vérifiez les langues prises en charge avant de changer de modèle">
...
<Admonition type="caution" title="N'intégrez jamais une clé partagée côté client">
