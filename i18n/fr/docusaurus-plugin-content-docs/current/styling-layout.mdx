---
lastmod: '2026-08-15T09:53:58.028Z'
...
DocStatic utilise <Url urlKey="infima" /> comme framework de stylisation sous-jacent. Infima fournit une mise en page flexible et des composants d'interface utilisateur courants adaptés aux sites web centrés sur le contenu (blogs, documentation, pages d'accueil). Pour plus de détails, consultez le <Url urlKey="infima" linkText={[{ lang: "fr", text: "site web d'Infima" }]} />.
