---
lastmod: '2026-08-11T23:03:29.559Z'
title: Installation
tags:
  - software
...
* [TinaCMS](https://tina.io/) — ブラウザベースでの編集を可能にします
* [LanguageTool](https://languagetool.org/) — オプションで文法およびスタイルチェックを提供します
...
[Node.js](https://nodejs.org/) バージョン 22.0 以降をインストールする必要があります。
...
1. [Node.js 公式ダウンロード](https://nodejs.org/en/download/prebuilt-installer) ページにアクセスします。
...
詳細については、Docusaurusのドキュメントにある [モノレポ](https://docusaurus.io/docs/installation#monorepos) を参照してください。
