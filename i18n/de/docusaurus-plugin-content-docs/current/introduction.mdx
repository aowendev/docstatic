---
lastmod: '2026-08-19T14:49:57.657Z'
...
docStatic begann als Weiterentwicklung von [Tinasaurus](https://tina.io/blog/tinasaurus-docusaurus-starter), einem Open-Source-Projekt auf Basis von <Url urlKey="react" />, das einen <Url urlKey="wikipedia-static-site-generator" linkText={[{ lang: "de", text: "Statik-Site-Generator" }]} /> (<Url urlKey="docusaurus" />) mit einem <Url urlKey="wikipedia-headless-content-management-system" linkText={[{ lang: "de", text: "Headless-Content-Management-System" }]} /> (<Url urlKey="tinacms" />). Es umfasst:
