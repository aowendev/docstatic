---
lastmod: '2026-08-11T23:19:41.601Z'
title: Introduction
tags:
  - software
...
docStatic ist eine Weiterentwicklung von [Tinasaurus](https://tina.io/blog/tinasaurus-docusaurus-starter), einem Open-Source-Projekt auf Basis von [React](https://react.dev/), das einen [Statik-Site-Generator](https://en.wikipedia.org/wiki/Static_site_generator) ([Docusaurus](https://docusaurus.io/)) mit einem [Headless-Content-Management-System](https://en.wikipedia.org/wiki/Headless_content_management_system) ([TinaCMS](https://tina.io/)). Es umfasst:
