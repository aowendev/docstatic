---
lastmod: '2026-08-11T23:19:40.952Z'
title: MDX and React
tags:
  - computer-languages
...
Vorlagen für native Komponenten, wie beispielsweise `Details`, müssen direkt in der Datei definiert werden. Zum Beispiel:
...
4. Wählen Sie den **Inhaltstyp** (**Markdown**, **HTML** oder **JSX**) aus.
