---
lastmod: '2026-08-19T14:49:56.430Z'
...
<Details summary="Anzeigen/Ausblenden.">
  Dies ist der detaillierte Inhalt.

  Sie können hier Markdown verwenden, einschließlich **fett** und *kursiv* formatiertem Text sowie eingebetteten [Links](https://docstatic.com/).
</Details>
...
Weitere Informationen finden Sie unter <Url urlKey="docusaurus-markdown-features" /> in der Docusaurus-Dokumentation.
