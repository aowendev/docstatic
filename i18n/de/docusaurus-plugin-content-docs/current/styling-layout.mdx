---
lastmod: '2026-08-15T09:53:51.502Z'
...
DocStatic verwendet <Url urlKey="infima" /> als zugrunde liegendes Styling-Framework. Infima bietet ein flexibles Layout und gängige UI-Komponenten, die sich für inhaltsorientierte Websites (Blogs, Dokumentationen, Homepages) eignen. Weitere Informationen finden Sie auf der <Url urlKey="infima" linkText={[{ lang: "de", text: "Infima-Website" }]} />.
