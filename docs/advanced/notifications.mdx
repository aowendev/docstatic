---
lastmod: '2026-08-15T14:47:37.170Z'
...
The `email-review.yml `and `email-translate.yml` actions are triggered when either the review or translate tags are set on a markdown file in the main branch. To use them, add these <Url urlKey="github-use-secrets" /> to your repository:
...
* <Url urlKey="icloud-mailserver" /> (requires an <Url urlKey="apple-app-specific-passwords" />.
