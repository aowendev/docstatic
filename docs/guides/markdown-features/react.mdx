---
title: MDX and React
description: Using React in DocStatic Markdown documents with MDX.
tags:
  - "computer-languages"
...
published: true
unlisted: false
lastmod: "2025-12-17T07:04:16.034Z"
---
...
4. Select the **Content Type** (**Markdown**, **HTML** or **JSX**).

The content is added directly to the page when the site is built, without the wrapper.

For examples, see the [example page](/example-page) and [math equations](/docs/guides/markdown-features/math-equations).
