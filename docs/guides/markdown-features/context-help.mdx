...
published: true
unlisted: false
lastmod: '2026-08-15T09:53:46.689Z'
modifiedBy: aowendev <aowen@translationcommons.org>
---
# Context-sensitive help

> "Context-sensitive help is a kind of <Url urlKey="wikipedia-online-help" /> that is obtained from a specific point in the state of the software, providing help for the situation that is associated with that state. Context-sensitive help, as opposed to general online help or online manuals, does not need to be accessible for reading as a whole. Each topic is supposed to describe extensively one state, situation, or feature of the software."—<Url urlKey="wikipedia-context-sensitive-help" linkText={[{ lang: "en", text: "Wikipedia" }]} />
