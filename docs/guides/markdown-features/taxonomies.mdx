---
title: Taxonomy tags
lastmod: '2026-08-15T09:53:47.564Z'
...
Taxonomy tags enable you to apply an <Url urlKey="wikipedia-information-architecture" /> to your site content. It should be applied to any documentation platforms you use, such as bug-tracking systems and wikis. The most restrictive tag requirements that you're likely to encounter are flat (non-hierarchical) systems that support only lower-case letters and underscores (`_`) without spaces.
