---
lastmod: '2026-08-12T18:46:20.541Z'
...
For more on the underlying model, see the [CALS table model reference](https://www.oasis-open.org/specs/tm9901.html) or the [DocBook table documentation](https://tdg.docbook.org/tdg/5.2/table.html).
