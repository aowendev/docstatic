...
DocStatic’s source code lives on GitHub. To start, you’ll need to make your own copy by either:

* **Creating a fork** of the DocStatic repository
  Forking creates a copy that you can use to work independently on your own project.

* **Creating a clone** of the DocStatic repository.
  Cloning makes a copy that is still associated with the original repository. 

Unless your IT department specifically ask you to clone the repository, we recommend that you create a fork.
...
### Clone the DocStatic repository

If your IT department require you to clone the DocStatic repository instead of creating a fork.

To create a clone, open your terminal or command prompt and use `cd` to navigate to the location where you want to store the clone. For example, `cd Documents/Projects/GitHub`.
...
After forking or cloning the repository, you will see these files in your `docstatic/` folder:
