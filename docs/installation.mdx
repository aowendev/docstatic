...
If you are going to work locally, you also need to install the project dependencies. Navigate to the root folder of your cloned DocStatic repository and install the packages:
