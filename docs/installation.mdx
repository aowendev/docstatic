...
### Can you use a monorepo?

Yes. DocStatic does allow the use of a single repo that contains both the project code and the project documentation. In Docusaurus terminology, this concept is called a “monorepo”.

For more information, see [Monorepos](https://docusaurus.io/docs/installation#monorepos) in the Docusaurus documentation.

***

### Preview changes with a local development server
