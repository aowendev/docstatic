...
published: true
unlisted: false
lastmod: '2026-08-13T12:17:12.564Z'
...
**Deployer-authored copy**—the launcher button label, the welcome message and the system prompts sent to each provider—lives in the CMS under **Chatbot Copy**, one document per language. A locale without its own document falls back to the default (English) copy.
