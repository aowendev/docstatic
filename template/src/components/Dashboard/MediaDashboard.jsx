    ...
    run(async ({ client, isCurrent }) => {
      ...
      const mediaStats = {
        ...
        totalSize: files.reduce(
          (acc, file) =>
            acc + (typeof file.size === "number" ? file.size / 1024 : 0),
          0
        ),
      };
      setMediaData({
  ...
  if (error) {
    return (
      ...
      >
        ...
        >
          <h3
            style={{ margin: "0 0 8px 0", color: "#d32f2f", fontSize: "16px" }}
          >
            Error
          </h3>
    ...
    >
      ...
      <div className="mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm flex items-center gap-4 p-6">
            ...
            <div className="min-w-0">
              ...
              <p className="text-3xl font-bold text-green-600">
                {
                  Object.values(imageUsages).filter(
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          <span
            style={{ fontSize: "14px", color: "#586069", marginRight: "12px" }}
          >
            Filter:
          </span>
        ...
        {filteredFiles.length === 0 ? (
          ...
          <div style={{ display: "grid", gap: "12px" }}>
            {filteredFiles.map((file, index) => (
              // biome-ignore lint/a11y/noStaticElementInteractions: hover styling only, nothing here is activatable
              <div
                key={index}
                style={{
                  position: "relative",
              ...
              >
                ...
                {expandedFile === file.path && (
                  ...
                  >
                    ...
                    >
                      Used in {(imageUsages[file.path] || []).length} document
                      {(imageUsages[file.path] || []).length !== 1 ? "s" : ""}:
                    </h4>
      ...
      {/* Lightbox */}
      {lightboxImage && (
        // biome-ignore lint/a11y/noStaticElementInteractions: click-to-dismiss backdrop; the close button provides the keyboard path
        <div
          role="presentation"
          style={{
            position: "fixed",
        ...
        >
          ...
          >
            ...
            >
              ...
              {lightboxImage.dimensions ? `• ${lightboxImage.dimensions}` : ""}{" "}
